...
export default function AdminInventoryPage() {
  ...
  const getAvailable = (item: InventoryItem) =>
    Math.max(item.quantity - item.reserved_quantity, 0);
      ...
      <div className="mx-auto max-w-7xl">
        <header className="mb-8">
          ...
          <p className="mt-2 max-w-2xl text-[#765f45]">
            Monitor product stock, reserved quantities, availability and
            stock health from verified inventory records.
          </p>
        </header>
        ...
        <section className="mb-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div className="rounded-xl border border-[#d8c8a8] bg-[#fffaf0] p-5">
            <div className="flex items-center justify-between">
              <p className="text-sm text-[#765f45]">Products</p>
              <Package size={20} className="text-[#641f2b]" />
            </div>
          ...
          <div className="rounded-xl border border-[#d8c8a8] bg-[#fffaf0] p-5">
            <p className="text-sm text-[#765f45]">Total Quantity</p>
          ...
          <div className="rounded-xl border border-[#d8c8a8] bg-[#fffaf0] p-5">
            <div className="flex items-center justify-between">
              <p className="text-sm text-[#765f45]">Out of Stock</p>
                ...
                {filtered.length === 0 && (
                  <tr>
                    <td colSpan={7} className="py-16 text-center">
                      ...
                      <p className="mx-auto mt-2 max-w-lg text-sm text-[#765f45]">
                        No verified inventory records are currently loaded.
                        Inventory quantities will appear here when the
                        confirmed inventory API response is connected.
                      </p>
                    </td>
                  </tr>
                )}
