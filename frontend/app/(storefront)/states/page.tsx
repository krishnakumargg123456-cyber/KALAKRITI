...
const states: StateInfo[] = [
  ...
  },
  {
    ...
    description:
      "Pattachitra, appliqué and stone traditions connect everyday craftsmanship with Odisha&apos;s cultural heritage.",
    crafts: ["Pattachitra", "Appliqué", "Stone Craft"],
  },
  {
    slug: "karnataka",
    name: "Karnataka",
          ...
          <div className="mx-auto max-w-3xl">
            ...
            <div className="mx-auto mt-8 flex max-w-xl items-center rounded-xl border border-[#e5c98b]/40 bg-[#fff8eb] px-4">
              ...
              <input
                ...
                aria-label="Search a state or craft"
