...
const crafts: Record<string, CraftData> = {
  madhubani: {
    ...
    technique:
      "Artists commonly work with fine lines, repeated patterns, geometric borders, and filled spaces. Natural-inspired motifs such as flowers, birds, fish, trees, and mythological figures create compositions where very little of the surface is left undecorated.",
    materials: ["Handmade paper", "Natural pigments", "Brushes", "Bamboo pens", "Cloth"],
    characteristics: [
  ...
  "blue-pottery": {
    ...
    materials: ["Quartz", "Glass", "Glazes", "Natural pigments", "Decorative colours"],
    characteristics: [
  ...
  "block-printing": {
    ...
    materials: ["Cotton fabric", "Carved wooden blocks", "Natural dyes", "Pigments", "Water"],
    characteristics: [
...
const fallbackCraft: CraftData = {
  ...
  materials: ["Natural materials", "Traditional tools", "Handmade surfaces", "Local pigments"],
  characteristics: [
    "Regional identity",
    "Handmade character",
...
export default async function CraftLearningPage({
  params,
}: {
  params: Promise<{ craftSlug: string }>;
}) {
  const { craftSlug } = await params;
  const craft = getCraft(craftSlug);
  ...
  return (
    <main className="min-h-screen bg-[#f7f0df] text-[#3d1f1b]">
      ...
      <section className="border-b border-[#b08a4a]/30">
        <div className="mx-auto grid max-w-7xl gap-10 px-6 py-12 sm:px-8 lg:grid-cols-[1fr_1fr] lg:items-center lg:px-12 lg:py-20">
          <div>
            <div className="flex flex-wrap items-center gap-2 text-xs font-semibold uppercase tracking-wider text-[#8b1e2d]">
              ...
              <span className="text-[#b08a4a]">â€¢</span>
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-2">
              <div className="flex items-center gap-3 rounded-lg border border-[#b08a4a]/30 bg-[#fbf6e9] p-4">
                <MapPin className="h-5 w-5 text-[#8b1e2d]" />
                <div>
              ...
              <div className="flex items-center gap-3 rounded-lg border border-[#b08a4a]/30 bg-[#fbf6e9] p-4">
                <Clock3 className="h-5 w-5 text-[#8b1e2d]" />
                <div>
                  <p className="text-[10px] font-bold uppercase tracking-wider text-[#80665d]">
                    Tradition
                  </p>
