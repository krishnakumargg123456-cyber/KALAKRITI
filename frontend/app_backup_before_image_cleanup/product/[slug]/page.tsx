    ...
    return (
      <main className="min-h-[70vh] bg-cream px-4 py-20">
        <div className="kalakriti-container text-center">
          <div className="mx-auto max-w-xl rounded-2xl border border-deep-maroon/10 bg-white/60 p-10">
            ...
            <Link
              href="/shop"
              className="mt-8 inline-flex items-center gap-2 rounded-lg bg-deep-maroon px-6 py-3 text-sm font-semibold text-cream"
            >
              <ArrowLeft size={17} />
              Back to Shop
            </Link>
    ...
    <main className="min-h-screen bg-cream">
      <div className="kalakriti-container px-4 py-8 md:py-12">
        ...
        <div className="mb-8 flex flex-wrap items-center gap-2 text-sm text-brown/70">
          <Link href="/" className="hover:text-deep-maroon">
            Home
          </Link>

          <span>/</span>

          <Link href="/shop" className="hover:text-deep-maroon">
            Shop
          </Link>
          ...
          {product.category?.name && (
            <>
              ...
              <Link
                ...
                className="hover:text-deep-maroon"
              >
                {product.category.name}
              </Link>
            </>
          ...
          <span className="truncate text-deep-maroon">
            {product.name}
          </span>
        </div>
        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:gap-14">
          ...
          <section>
            <div className="relative overflow-hidden rounded-2xl border border-deep-maroon/10 bg-white">
              {currentImage ? (
                <img
                  src={currentImage}
                  alt={product.name}
                ...
                <div className="flex aspect-square items-center justify-center bg-[#eee5d3]">
                  <ShoppingBag
                    size={70}
                    strokeWidth={1}
              ...
              {hasDiscount && (
                <span className="absolute left-5 top-5 rounded-full bg-deep-maroon px-4 py-2 text-xs font-bold text-cream">
                  {discountPercent}% OFF
                </span>
              )}
              ...
              <button
                ...
                className="absolute right-5 top-5 flex h-11 w-11 items-center justify-center rounded-full border border-deep-maroon/10 bg-cream/95"
          ...
          <section className="flex flex-col">
            ...
            <h1 className="mt-3 font-serif text-4xl font-bold leading-tight text-deep-maroon md:text-5xl">
              {product.name}
            </h1>
            ...
            <div className="mt-7 flex flex-wrap items-end gap-3">
              <span className="font-serif text-4xl font-bold text-deep-maroon">
              ...
              {hasDiscount && (
                <>
                  ...
                  <span className="mb-1 rounded bg-heritage-green/10 px-2 py-1 text-xs font-bold text-heritage-green">
            ...
            <div className="mt-7 border-y border-deep-maroon/10 py-6">
            ...
            {product.artisan && (
              <div className="mt-6 rounded-xl border border-gold/30 bg-[#f6eedf] p-5">
                ...
                <div className="mt-2 flex items-center justify-between gap-4">
                  ...
                  {product.artisan.slug && (
                    <Link
                      ...
                      className="text-sm font-semibold text-deep-maroon underline"
                    >
                      View Artisan
                    </Link>
                  )}
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row">
              <div className="flex h-14 items-center rounded-lg border border-deep-maroon/20 bg-white">
                <button
                  type="button"
                ...
                <span className="w-10 text-center font-semibold text-deep-maroon">
                  {quantity}
                </span>
              ...
              <button
                ...
                className="flex h-14 flex-1 items-center justify-center gap-3 rounded-lg bg-deep-maroon px-6 font-semibold text-cream disabled:opacity-50"
              >
                <ShoppingBag size={20} />
            ...
            <button
              ...
              disabled={soldOut}
              className="mt-3 h-14 w-full rounded-lg border border-deep-maroon font-semibold text-deep-maroon hover:bg-deep-maroon hover:text-cream disabled:opacity-40"
            >
              Buy Now
            </button>

            <div className="mt-8 grid gap-4 border-t border-deep-maroon/10 pt-7 sm:grid-cols-3">
        ...
        <section className="mt-20 border-t border-deep-maroon/10 pt-12">
        ...
        <div className="mt-12 border-t border-deep-maroon/10 pt-8">
          <Link
            href="/shop"
